...
class Casa(Imovel):
    def __init__(self, inscriçaoMunicipal, Valor_aluguel, IPTU,piscina,sala_de_estar,churrasqueira):
...
class Apartamento(Imovel):
    def __init__(self, inscriçaoMunicipal,Valor_aluguel, IPTU,elevador,andar,quartos):
        super().__init__(inscriçaoMunicipal, Valor_aluguel, IPTU)
...
class Chacara(Imovel):
    def __init__(self, inscriçaoMunicipal, Valor_aluguel, IPTU,pesqueiro,rio):
        super().__init__(inscriçaoMunicipal, Valor_aluguel, IPTU)
        self.pesqueiro = pesqueiro
        self.rio = rio

casa = Casa("07322649000178",1000,500,"olimpica","grande","3 andares")
print(casa.inscricaoMunicipal)
